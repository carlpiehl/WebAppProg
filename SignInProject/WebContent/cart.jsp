<%@ page import="java.sql.*, javax.sql.*, javax.naming.*, java.util.*, java.util.concurrent.atomic.AtomicInteger" language="java" contentType="text/html; charset=ISO-8859-1"
	...
	<table width="90%" border="1">
		...
		for(String product: cart.keySet()){
			...
			pst.setString(1, product);
			 ...
			 out.write("<td><center> <form action='addCartServlet' method='post'> <input type='hidden' name= 'productID' value=" 
			 + productID + "> <input id='text' type='submit' value='+' ></form></center></td>");
			 
			 out.write("<td><center> <form action='subCartServlet' method='post'> <input type='hidden' name= 'productID' value=" 
					 + productID + "> <input id='text' type='submit' value='-' ></form></center></td>");
			 
			 out.write("<td><center> <form action='removeFromCartServlet' method='post'> <input type='hidden' name= 'productID' value=" 
			 + productID + "> <input id='text' type='submit' value='Remove' ></form></center></td>");
